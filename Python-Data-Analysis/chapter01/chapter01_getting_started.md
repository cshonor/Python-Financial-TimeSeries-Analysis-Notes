...
已整理：[01_01_本书内容](./sections/01_01_本书内容.md)（**五大类任务全书骨架** + 13 章对照表）

### 1.2 为什么使用 Python

已整理：[01_02_为什么使用_Python_进行数据分析](./sections/01_02_为什么使用_Python_进行数据分析.md)（生态、GIL、工具对比、核心库速查）
...
- [1.4 安装和设置](./sections/01_04_安装和设置.md)（Miniconda / venv / Docker、换源、验证脚本）
- 1.5、1.6（留白）
