...
McKinney 按 **读入 → 清洗整理 → 转换衍生 → 建模分析 → 可视化报告** 组织全书。详细说明与 **13 章对照表** 见 [chapter01/sections/01_01_本书内容.md](./chapter01/sections/01_01_本书内容.md)。

| # | 任务 | 主要章节 |
|---|------|----------|
| ① | 与外部世界交互（I/O） | 第 3、6 章 |
| ② | 数据准备（清洗/规整） | 第 5、7、8 章 |
| ③ | 数据转换（聚合/衍生） | 第 4、5、10、11 章 |
| ④ | 建模和计算 | 第 12、13 章 |
| ⑤ | 演示（可视化/报告） | 第 9、13 章 |
