...
**前置**：[第 6 章 数据 I/O](./chapter06_data_io_file_formats.md) → 本章 → [第 8 章 数据规整](./chapter08_data_wrangling_join_reshape.md)。
...
- 下一章：[第 8 章 连接、联合和重塑](./chapter08_data_wrangling_join_reshape.md)。
