...
本目录是 **《Python金融大数据分析（第2版）》第 5 章 pandas 数据分析** 的深化专题：以原书章节为结构蓝本，结合量化金融与 statsmodels 建模前置，形成「知识点提炼 + 语法速查 + 示例 + 量化改造」笔记。

**章总览**：[`../../chapter05/chapter05_pandas_data_analysis.md`](../../chapter05/chapter05_pandas_data_analysis.md)
...
| 维度 | 说明 |
|------|------|
| **核心蓝本** | 《Python金融大数据分析（第2版）》第 5 章及后续 pandas 应用章节 |
